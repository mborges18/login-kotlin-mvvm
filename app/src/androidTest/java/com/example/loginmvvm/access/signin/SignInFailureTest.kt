...
import com.example.loginmvvm.AccessActivityAction.checkMessageFailure
...
import com.example.loginmvvm.AccessActivityModule.getModuleSignInFailure
...
class SignInFailureTest {
    ...
    @Before
    fun setup() {
        loadKoinModules(getModuleSignInFailure())
    ...
    @Test
    fun flow_to_make_signIn_messages_failure() {
        typeValidDataSignIn()
        clickButtonSignIn()
        checkMessageFailure()
    }
